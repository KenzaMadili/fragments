...
*(Ajoute ici une capture de l’écran avec les deux boutons)*
...
*(Ajoute ici une capture après clic sur Fragment A)*
...
*(Ajoute ici une capture après clic sur Fragment B)*
